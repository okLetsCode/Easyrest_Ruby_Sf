...
class OrderingFood
  ...
  SELECT_QUANTITY = { xpath: "//div[@class='MuiInputBase-root-474 MuiInput-root-461 MuiInput-underline-465 MuiInputBase-focused-476 MuiInput-focused-463 MuiInputBase-formControl-475 MuiInput-formControl-462']//input[@id='quantity']" }.freeze
